...
import net.michael.croissantmod.item.custom.CroissantWandItem;
...
public class ModItems {
    ...
    public static final Item CROISSANTWAND = registerItem("croissant_wand", new CroissantWandItem(new Item.Settings().maxDamage(32)));
